...
data08 %>% datatable(escape=FALSE, rownames = F, options = list(pageLength = 3, scrollY = '390px', paging = T,
    initComplete = JS("function(settings, json) {",
    "$(this.api().table().header()).css({'font-size': '72%','background-color': '#000', 'color': '#fff'});","}"))) %>%
    formatStyle(1:6, 'vertical-align'='top',fontSize = '72%')
